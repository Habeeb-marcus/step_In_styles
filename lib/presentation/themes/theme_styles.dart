...
class Styles {
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
      ...
      scaffoldBackgroundColor: isDarkTheme ? AppColors.secondary : AppColors.greyBackground,
      ...
      appBarTheme: AppBarTheme(
          elevation: 0.0,
          color: isDarkTheme ? AppColors.Bblack : AppColors.greyBackground,
          centerTitle: true,
        ...
        // !card theme
      cardTheme:   CardTheme(
      color: isDarkTheme ? AppColors.Bblack : AppColors.white,
      elevation: 0,
    ...
    //   backgroundColor: isDarkTheme ? AppColors.purple : AppColors.white,
    //   elevation: 0,
    //   selectedItemColor: AppColors.primary,
    //   unselectedItemColor: AppColors.black2,
    //   selectedLabelStyle: AppTextStyle.bodyFour.copyWith(
    //     color: AppColors.primary,
    //   ),
    ...
    bottomAppBarTheme: BottomAppBarTheme(
      ...
      shadowColor: isDarkTheme ? AppColors.Bblack : AppColors.white,
    ),
    );
