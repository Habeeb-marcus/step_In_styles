...
class AppTextStyle {
  static TextStyle get headerOne => const TextStyle(
      fontWeight: FontWeight.w700, fontSize: 42, height: 56 / 42);
  ...
  static TextStyle get bodyOne => const TextStyle(
      fontWeight: FontWeight.w400, fontSize: 16, height: 32 / 16);
  ...
  static TextStyle get bodyFour => const TextStyle(
      fontWeight: FontWeight.w500, fontSize: 20, height: 32 / 20);
