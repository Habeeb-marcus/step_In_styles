...
class AppColors {
  ...
  // static const Color secondary = Color(0xFF2D3B48);
  static const Color secondary = Color(0xFF202327);
  static const Color textGray = Color(0xFF979797);
  static const Color progressIndicatorBackgroundDark = Color(0xFF333333);
  static const Color black = Color(0xFF000000);
  static const Color black2 = Color(0xFF1A2530);
  static const Color black3 = Color(0xFF707B81);
  static const Color Bblack = Color(0xFF12161b);
  ...
  static const Color lightGrey = Color(0xFFE5EEF7);
